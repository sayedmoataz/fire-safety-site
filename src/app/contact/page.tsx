    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <label
          ...
          className="block text-sm font-bold text-gray-700"
        >
          الرسالة أو الاستفسار <span className="text-red-500">*</span>
        </label>
        <textarea
          id="message"
          required
      ...
      <div className="bg-blue-50 border border-blue-100 p-4 rounded-lg flex items-start gap-3">
        ...
        <p className="text-sm text-blue-800 leading-relaxed">
          عند الضغط على إرسال، سيتم تحويلك إلى تطبيق واتساب لإرسال رسالتك مباشرة
          إلى فريق الدعم الخاص بنا.
        </p>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mt-6">
            نحن هنا لخدمتكم والإجابة على كافة استفساراتكم. نسعد بتواصلكم معنا
            على مدار الساعة.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            ...
            {/* Embedded Google Map */}
            <div className="bg-white p-2 rounded-2xl shadow-sm border border-gray-100 overflow-hidden h-64 relative group">
              <iframe
                title="موقع الشركة على الخريطة"
                src={`https://maps.google.com/maps?q=${siteConfig.coordinates.lat},${siteConfig.coordinates.lng}&t=&z=18&ie=UTF8&iwloc=&output=embed`}
                width="100%"
                height="100%"
                style={{ border: 0 }}
              ...
              <a
                ...
                className="absolute bottom-4 right-4 bg-white/95 text-[#D32F2F] hover:bg-[#D32F2F] hover:text-white transition-colors duration-200 px-4 py-2 rounded-lg font-bold shadow-md flex items-center gap-2 text-sm z-10"
              >
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8">
              قم بتعبئة النموذج التالي وسيقوم فريقنا بالتواصل معك في أقرب وقت.
            </p>
            <Suspense
              fallback={
